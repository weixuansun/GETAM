...
def forward_vit(pretrained, x):
    ...
    glob, res_features = pretrained.model.forward_flex(x)
...
def _make_pretrained_vitl16_384(
    ...
    model = create_model("vit_large_patch16_384", pretrained=pretrained)
...
def _make_pretrained_deitb16_384(
    ...
    model = create_model("vit_deit_base_patch16_384", pretrained=pretrained)
